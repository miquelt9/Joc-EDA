...
struct PLAYER_NAME : public Player {
  ...
  Dir bfs_search(int i, int j, const Board& B, bool avoid_active){
...
*/
      ...
      if (z.type == CITY){
        int cid = z.city_id;
        if (city_owner(cid) == me()){
          Dir new_set_moves = bfs_search(u.pos.j, u.pos.i, board, true);
          move(id, new_set_moves);
          return;
        }
